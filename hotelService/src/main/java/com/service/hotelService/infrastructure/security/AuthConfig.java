package com.service.hotelService.infrastructure.security;

import com.service.hotelService.infrastructure.property.RsaProperty;
...
//                .cors(c -> c.disable())
                ...
                .authorizeHttpRequests(a -> a
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/error", "/api/v1/hotels/**", "/api/v1/rooms/**", "/api/v1/reservations/**").permitAll()
